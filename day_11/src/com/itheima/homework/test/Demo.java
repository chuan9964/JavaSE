...
public class Demo {
    ...
    public static  ArrayList<Product> parseText() throws Exception{
        ...
        BufferedReader bufferedReader = new BufferedReader(new FileReader("E:\\讲义\\itheima\\code\\project_javaseup\\day_11\\src\\com\\itheima\\homework\\test\\products.txt"));

        String input;
        while ((input=bufferedReader.readLine()) != null){
            // 使用带参构造函数创建对象
            list.add(new Product(input));
        }
        return list;
    }
